...
static int ti83pfamily_dump(CalcHandle *h)
{
	...
	if (f != NULL)
	{
		...
		if ((ti73_send_DUMP(h, (uint16_t)page) == 0) && (ti73_recv_ACK(h, NULL) == 0) && (ti73_recv_XDP(h, &length, buffer) == 0) && (ti73_send_ACK(h) == 0))
		{
...
{
	if ((ti73_send_EKE(h) == 0) && (ti73_recv_ACK(h, NULL) == 0))
	{
...
{
	if ((ti73_send_DKE(h) == 0) && (ti73_recv_ACK(h, NULL) == 0))
	{
...
{
	if ((ti73_send_ELD(h) == 0) && (ti73_recv_ACK(h, NULL) == 0))
	{
...
{
	if ((ti73_send_DLD(h) == 0) && (ti73_recv_ACK(h, NULL) == 0))
	{
...
static int ti83pfamily_gid(CalcHandle *h)
{
	...
	if ((ti73_send_GID(h) == 0) && (ti73_recv_ACK(h, NULL) == 0) && (ti73_recv_XDP(h, &length, buffer) == 0) && (ti73_send_ACK(h) == 0))
	{
...
static int ti83pfamily_rid(CalcHandle *h)
{
	...
	if ((ti73_send_RID(h) == 0) && (ti73_recv_SID(h, &length, buffer) == 0) && (ti73_send_ACK(h) == 0))
	{
...
static int ti83pfamily_sid(CalcHandle *h)
{
	...
	if ((ti73_send_SID(h, DATA) == 0) && (ti73_recv_ACK(h, NULL) == 0))
	{
